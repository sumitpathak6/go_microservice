...
import (
	...
	"github.com/sumitpathak6/go_microservice/model"
	"github.com/sumitpathak6/go_microservice/repository/order"
)
...
func (h *Order) GetbyId(w http.ResponseWriter, r *http.Request) {
	...
	orderId, err := strconv.ParseUint(idParam, base, baseSize)
	if err != nil {
		w.WriteHeader(http.StatusBadRequest)
		return
	}
